...
<div id="wclsp-sales-popup" class="wclsp-sales-popup" aria-live="polite" role="region">
    <div class="wclsp-popup-inner">
        <button type="button" class="wclsp-close-btn" aria-label="<?php esc_attr_e( 'Close notification', 'flashproof-sales-popup-for-woo' ); ?>">&times;</button>
        <div class="wclsp-prod-img">
            <img id="wclsp-popup-img" src="" alt="<?php esc_attr_e( 'Product', 'flashproof-sales-popup-for-woo' ); ?>">
        </div>
        <div class="wclsp-popup-text">
            <p class="wclsp-buyer-line">
                ...
                <span class="wclsp-action-text"><?php esc_html_e( 'just bought', 'flashproof-sales-popup-for-woo' ); ?></span>
            </p>
            ...
            <div class="wclsp-meta-line">
                ...
                <span class="wclsp-verified-badge">&#10003; <?php esc_html_e( 'Verified', 'flashproof-sales-popup-for-woo' ); ?></span>
            </div>
        </div>
    </div>
</div>
